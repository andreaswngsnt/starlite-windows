...
class MyApp(tk.Tk):
    ...
    def open_map_window(self):
        ...
        mapview = tk.Toplevel(self)
        mapview.title("Mapview")
        mapview.geometry(f"{800}x{600}")

        my_label = LabelFrame(mapview)
        my_label.pack(pady=20)

        # create map widget
        map_widget = tkintermapview.TkinterMapView(mapview, width=800, height=600, corner_radius=0)
        map_widget.pack()

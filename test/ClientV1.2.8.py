...
class LoginPage(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def getlogin():
            ...
            if validation:
                try:
                    self.server_address = '127.0.0.1' #Server IP (Use '127.0.0.1' for local testing and '192.168.0.185' to connect to robot)
                    self.server_port = 12345 #Server Port
...
class MenuBar(tk.Menu):
    def __init__(self, parent):
        ...
        menu_positions.add_command(label="Enable Autonomous Navigation", command=lambda: parent.Autonomous_Control())
...
class CameraFeed(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            # Release resources:
            cv2.destroyAllWindows() #Depth Camera Test (end)
    ...
    def __init__(self, *args, **kwargs):
        ...
        def keyboard_listener():
            try:
                ...
                while True:
                    ...
                    if event.event_type == keyboard.KEY_DOWN:
                        if key not in keys_pressed:
                            ...
                            continue
                    elif (event.event_type == keyboard.KEY_UP) & (key != 'q'):
                ...
                #Display warning that manual control is turning off:
                print("Disabling manual control...")
        ...
        #Function to stop sampling keyboard inputs:
        def stop_keyboard_listener(self):
            #Unhook all events related to keyboard sampling:
            keyboard.unhook_all()

            #Display notification that manual control has been disabled:
            print("Manual Control Disabled.")

#Autonomous Control:
class Autonomous_Control(tk.Tk):
    def __init__(self, *args, **kwargs):
        tk.Tk.__init__(self, *args, **kwargs)
        self.withdraw()
